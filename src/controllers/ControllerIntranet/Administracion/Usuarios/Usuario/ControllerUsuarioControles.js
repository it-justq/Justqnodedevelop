...
module.exports = {
    ...
    async getControlesUsuario(req, res){
        ...
        if(await isPermissedTo(cnf.user_id, cnf.rol, 'ADMIN-USUARIOS')){
            ...
            res.render(modules+'controles', {layout: layout+'controles.hbs', csrfToken: req.csrfToken(), data, menuAdmin, pagina: cnf.pagina, user, nav});
        }else{
    ...
    async postControlesUsuario(req, res){

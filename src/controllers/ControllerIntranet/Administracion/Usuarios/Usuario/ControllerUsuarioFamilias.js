...
module.exports = {
    ...
    async getFamiliasUsuario(req, res){
        ...
        if(await isPermissedTo(cnf.user_id, cnf.rol, 'ADMIN-USUARIOS')){
            ...
            res.render(modules+'familias', {layout: layout+'familias.hbs', csrfToken: req.csrfToken(), data, menuAdmin, pagina: cnf.pagina, user, nav});
        }else{
    ...
    async postFamiliasUsuario(req, res){

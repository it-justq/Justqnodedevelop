...
module.exports = {
    ...
    async getInformacion(req, res){
        ...
        if(await permisosControl(cnf.control_id, cnf.user_id, cnf.rol)){
            ...
            res.render(modules+'informacion', {layout: layout+'informacion.hbs', csrfToken: req.csrfToken(), menuControl, activePrecarga, menuInformacion, data, control_codigo, control_id: cnf.control_hash, user, nav});

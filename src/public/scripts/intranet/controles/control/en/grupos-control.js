function uploadDatos(id, controlId, value, type, subtype){
	...
	$.ajax({
		data:  parametros,
		url:   '/intranet/control/en/'+controlId+'/grupos-control/mod',
		headers: {
			'CSRF-Token': token
		},
		type:  'POST',
...
function addPc(id, controlId){
	...
	$.ajax({
		data:  parametros,
		url:   '/intranet/control/en/'+controlId+'/grupos-control/add/pc/'+id,
		headers: {
			'CSRF-Token': token
		},
		type:  'POST',
...
function uploadDatosAdded(id, controlId, value, type, subtype){
	...
	$.ajax({
		data:  parametros,
		url:   '/intranet/control/en/'+controlId+'/grupos-control-added/mod/'+id,
		headers: {
			'CSRF-Token': token
		},
		type:  'POST',
...
function delPcAdded(id, controlId){
	...
	$.ajax({
		data:  parametros,
		url:   '/intranet/control/en/'+controlId+'/grupos-control-added/delete/pc/'+id,
		headers: {
			'CSRF-Token': token
		},
		type:  'POST',

function modDatos(id, tipoControlId, value, type, lan){
	...
	$.ajax({
		data:  parametros,
		url:   '/intranet/administracion/controles/en/tipo-control/'+tipoControlId+'/editar',
		headers: {
			'CSRF-Token': token
		},
		type:  'POST',
...
function addPuntoControl(grupoControlId, tipoControlId){
	...
	$.ajax({
		data:  parametros,
		url:   '/intranet/administracion/controles/en/tipo-control/'+tipoControlId+'/grupos-control/'+grupoControlId+'/puntos-control/nuevo',
		headers: {
			'CSRF-Token': token
		},
		type:  'POST',

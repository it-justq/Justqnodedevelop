...
module.exports = {
    ...
    async getControlesFinalizadosListMysql(PARAMS, inicio_pagina) {
        ...
        try {
            ...
            let estado = " control_estado = 1 AND ";

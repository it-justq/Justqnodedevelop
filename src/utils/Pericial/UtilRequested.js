const {idInforme} = require('./UtilCommon');
...
module.exports = {
    ...
    async requested(req){
        ...
        let informe_id_hash = await escapeData(req.params.controlId);
        let informe_id = await idInforme(informe_id_hash);
        
        let requested = {
            informe_id: informe_id,
            informe_hash: informe_id_hash,
